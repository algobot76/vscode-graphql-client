...
export var ParserRules: NearleyRule[] = [
    ...
    {"name": "query$ebnf$1", "symbols": ["query_prompt"], "postprocess": id},
    {"name": "query$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "query$ebnf$2$subexpression$1", "symbols": ["letter"]},
    {"name": "query$ebnf$2$subexpression$1", "symbols": ["space"]},
    {"name": "query$ebnf$2$subexpression$1", "symbols": ["brace"]},
    {"name": "query$ebnf$2$subexpression$1", "symbols": ["new_line"]},
    {"name": "query$ebnf$2", "symbols": ["query$ebnf$2$subexpression$1"]},
    {"name": "query$ebnf$2$subexpression$2", "symbols": ["letter"]},
    {"name": "query$ebnf$2$subexpression$2", "symbols": ["space"]},
    {"name": "query$ebnf$2$subexpression$2", "symbols": ["brace"]},
    {"name": "query$ebnf$2$subexpression$2", "symbols": ["new_line"]},
    {"name": "query$ebnf$2", "symbols": ["query$ebnf$2", "query$ebnf$2$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "query", "symbols": ["query$ebnf$1", {"literal":"{"}, "new_line", "query$ebnf$2", "new_line", {"literal":"}"}]},
    {"name": "query_prompt$string$1", "symbols": [{"literal":"q"}, {"literal":"u"}, {"literal":"e"}, {"literal":"r"}, {"literal":"y"}], "postprocess": (d) => d.join('')},
    {"name": "query_prompt$ebnf$1$subexpression$1", "symbols": ["space", "word"]},
    ...
    {"name": "query_prompt$ebnf$2$subexpression$1$ebnf$1", "symbols": []},
    {"name": "query_prompt$ebnf$2$subexpression$1$ebnf$1", "symbols": ["query_prompt$ebnf$2$subexpression$1$ebnf$1", "space"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "query_prompt$ebnf$2$subexpression$1$ebnf$2", "symbols": []},
    {"name": "query_prompt$ebnf$2$subexpression$1$ebnf$2", "symbols": ["query_prompt$ebnf$2$subexpression$1$ebnf$2", "space"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "query_prompt$ebnf$2$subexpression$1$ebnf$3", "symbols": []},
    {"name": "query_prompt$ebnf$2$subexpression$1$ebnf$3", "symbols": ["query_prompt$ebnf$2$subexpression$1$ebnf$3", "space"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "query_prompt$ebnf$2$subexpression$1$ebnf$4", "symbols": []},
    {"name": "query_prompt$ebnf$2$subexpression$1$ebnf$4", "symbols": ["query_prompt$ebnf$2$subexpression$1$ebnf$4", "space"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "query_prompt$ebnf$2$subexpression$1$ebnf$5", "symbols": []},
    {"name": "query_prompt$ebnf$2$subexpression$1$ebnf$5", "symbols": ["query_prompt$ebnf$2$subexpression$1$ebnf$5", "space"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "query_prompt$ebnf$2$subexpression$1$ebnf$6", "symbols": []},
    {"name": "query_prompt$ebnf$2$subexpression$1$ebnf$6", "symbols": ["query_prompt$ebnf$2$subexpression$1$ebnf$6", "space"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "query_prompt$ebnf$2$subexpression$1", "symbols": ["query_prompt$ebnf$2$subexpression$1$ebnf$1", {"literal":"("}, "query_prompt$ebnf$2$subexpression$1$ebnf$2", "query_variable", "query_prompt$ebnf$2$subexpression$1$ebnf$3", {"literal":":"}, "query_prompt$ebnf$2$subexpression$1$ebnf$4", "query_argument", "query_prompt$ebnf$2$subexpression$1$ebnf$5", {"literal":")"}, "query_prompt$ebnf$2$subexpression$1$ebnf$6"]},
    ...
    {"name": "query_prompt$ebnf$3", "symbols": []},
    {"name": "query_prompt$ebnf$3", "symbols": ["query_prompt$ebnf$3", "space"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "query_prompt", "symbols": ["query_prompt$string$1", "query_prompt$ebnf$1", "query_prompt$ebnf$2", "query_prompt$ebnf$3"]},
