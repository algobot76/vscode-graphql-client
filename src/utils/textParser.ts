...
export var ParserRules: NearleyRule[] = [
    ...
    {"name": "query$ebnf$2", "symbols": ["query$ebnf$2", "space"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "query$ebnf$3$subexpression$1", "symbols": ["letter"]},
    {"name": "query$ebnf$3$subexpression$1", "symbols": ["space"]},
    {"name": "query$ebnf$3$subexpression$1", "symbols": ["brace"]},
    {"name": "query$ebnf$3$subexpression$1", "symbols": ["new_line"]},
    {"name": "query$ebnf$3", "symbols": ["query$ebnf$3$subexpression$1"]},
    {"name": "query$ebnf$3$subexpression$2", "symbols": ["letter"]},
    {"name": "query$ebnf$3$subexpression$2", "symbols": ["space"]},
    {"name": "query$ebnf$3$subexpression$2", "symbols": ["brace"]},
    {"name": "query$ebnf$3$subexpression$2", "symbols": ["new_line"]},
    {"name": "query$ebnf$3", "symbols": ["query$ebnf$3", "query$ebnf$3$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "query", "symbols": ["query$ebnf$1", "query$ebnf$2", {"literal":"{"}, "new_line", "query$ebnf$3", "new_line", {"literal":"}"}]},
